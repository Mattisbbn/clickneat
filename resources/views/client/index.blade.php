    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasCart" aria-labelledby="My Cart">
      ...
      <div class="offcanvas-body">
        <div class="order-md-last">
          ...
          <button class="w-100 btn btn-primary btn-lg" type="submit">Finaliser la commande</button>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="banner-blocks">
                  ...
                  <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        ...
                        <div class="img-wrapper col-md-5">
                          <img src="{{ asset("foodmart/images/product-thumb-1.png") }}" class="img-fluid">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="swiper-slide">
                      <div class="row banner-content p-5">
                        ...
                        <div class="img-wrapper col-md-5">
                          <img src="{{ asset("foodmart/images/product-thumb-2.png") }}" class="img-fluid">
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="banner-ad bg-success-subtle block-2" style="background:url('{{ asset("foodmart/images/ad-image-1.png") }}') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
              ...
              <div class="banner-ad bg-danger block-3" style="background:url('{{ asset("foodmart/images/ad-image-2.png") }}') no-repeat;background-position: right bottom">
                <div class="row banner-content p-5">
            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset("foodmart/images/icon-vegetables-broccoli.png") }}" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset("foodmart/images/icon-bread-baguette.png") }}" alt="Category Thumbnail">
                  <h3 class="category-title">Breads & Sweets</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset("foodmart/images/icon-soft-drinks-bottle.png") }}" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset("foodmart/images/icon-wine-glass-bottle.png") }}" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset("foodmart/images/icon-animal-products-drumsticks.png") }}" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset("foodmart/images/icon-bread-herb-flour.png") }}" alt="Category Thumbnail">
                  <h3 class="category-title">Fruits & Veges</h3>
                </a>
                <a href="index.html" class="nav-link category-item swiper-slide">
                  <img src="{{ asset("foodmart/images/icon-vegetables-broccoli.png") }}" alt="Category Thumbnail">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex justify-content-between">
              ...
              <h2 class="section-title">Nouveau plats</h2>
